                            ...
                            <tbody>
                              <tr>
                                <td align="center" bgcolor="#ED342F" role="presentation" style="border:none;border-radius:8px;cursor:auto;mso-padding-alt:16px 32px;background:#ED342F;" valign="middle">
                                  <p style="display: inline-block; background: #ED342F; color: white; font-family: 'Source Sans 3', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold; line-height: 120%; margin: 0; text-decoration: none; text-transform: none; padding: 16px 32px; mso-padding-alt: 0px; border-radius: 8px;"> Confirm my account </p>
                                </td>
                              </tr>
                            </tbody>
                          </table>
