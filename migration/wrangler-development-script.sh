...
# Create tables
wrangler d1 execute vms-local-db --local --command "CREATE TABLE IF NOT EXISTS profile (id TEXT PRIMARY KEY NOT NULL UNIQUE COLLATE BINARY, email TEXT NOT NULL UNIQUE, password TEXT NOT NULL, schemaVersion INTEGER NOT NULL, name TEXT NOT NULL, description TEXT, happenedAt DATE NOT NULL, insertedAt DATE NOT NULL, links TEXT, activatedAt DATE);"
