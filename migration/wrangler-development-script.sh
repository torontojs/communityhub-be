...
# Create tables
wrangler d1 execute vms-local-db --local --command "CREATE TABLE IF NOT EXISTS profile (id TEXT PRIMARY KEY NOT NULL UNIQUE COLLATE BINARY, email TEXT NOT NULL UNIQUE, password TEXT NOT NULL UNIQUE, schemaVersion INTEGER NOT NULL, name TEXT NOT NULL, description TEXT, happenedAt TEXT NOT NULL, insertedAt TEXT NOT NULL, links TEXT);"
...
wrangler d1 execute vms-local-db --local --command "INSERT INTO profile (id, email, password, schemaVersion, name, description, happenedAt, insertedAt, links) VALUES ('3227114d-43c4-42ed-8aea-f3860fe42222', 'profile1@example.com', 'password1', 1, 'John Doe', 'A sample profile description', '2025-01-20T10:00:00Z', '2025-01-20T10:00:00Z', 'https://example.com');"
wrangler d1 execute vms-local-db --local --command "INSERT INTO profile (id, email, password, schemaVersion, name, description, happenedAt, insertedAt, links) VALUES ('aa7e8915-8034-43d9-b910-a2e3ebdb947f', 'profile2@example.com', 'password2', 1, 'Jane Smith', 'Another sample profile description', '2025-01-20T11:00:00Z', '2025-01-20T11:00:00Z', 'https://example.com');"
wrangler d1 execute vms-local-db --local --command "INSERT INTO profile (id, email, password, schemaVersion, name, description, happenedAt, insertedAt, links) VALUES ('aa7e8915-8034-43d9-b910-a2e3ebdb947z', 'profile3@example.com', 'password3', 1, 'Jane Doe', 'Another sample profile description', '2025-01-21T11:00:00Z', '2025-01-21T11:00:00Z', 'https://example.com');"
